...
/**
 * Spinner
 * @param Spinner - Has all HTMLAttributes<HTMLDivElement>
 * @param Spinner.className - To style the spinner, mainly for size and color (additional class will get merged by cn()).
 * @returns JSX.Element
 * @example
...
export function Spinner({ className, ...rest }: SpinnerProps) {
  return (
    <div className={cn("h-5 w-5 text-muted-foreground", className)} {...rest}>
